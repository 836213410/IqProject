       ...
       // int result = scanner();
        ...
        AutoGenerator mpg = new AutoGenerator().setGlobalConfig(
            ...
            new StrategyConfig()
                ...
                // 自定义实体，公共字段
                .setSuperEntityColumns(new String[]{"MARKET_USER"})
            ...
            new InjectionConfig() {
                ...
                public String outputFile(TableInfo tableInfo) {
                    return "D:/out/mapper/xml/" + tableInfo.getEntityName() + ".xml";
                }
            }))
        ).setTemplate(
